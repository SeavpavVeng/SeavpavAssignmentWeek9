...
<head>
  ...
  <link href="{{asset('fe/vendor/ionicons/css/ionicons.min.css')}}" rel="stylesheet">
  <link href="{{asset('fe/vendor/animate.css/animate.min.css')}}" rel="stylesheet">
  <link href="{{asset('fe/vendor/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet">
...
<body>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item" href="{{url('/')}}">Agent Single</a>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="agent-avatar-box">
                  <img src="{{asset('fe/img/agent-7.jpg')}}" alt="" class="agent-avatar img-fluid">
                </div>
              </div>
          ...
          <div class="row property-grid grid">
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="{{asset('fe/img/property-1.jpg')}}" alt="" class="img-a img-fluid">
                </div>
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="{{asset('fe/img/property-3.jpg')}}" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="{{asset('fe/img/property-6.jpg')}}" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="{{asset('fe/img/property-7.jpg')}}" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="{{asset('fe/img/property-8.jpg')}}" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="{{asset('fe/img/property-10.jpg')}}" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
  ...
  <script src="{{asset('fe/vendor/scrollreveal/scrollreveal.min.js')}}"></script>
