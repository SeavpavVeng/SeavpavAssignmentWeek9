        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="{{url('/')}}">Property Single</a>
          ...
          <div class="col-sm-12">
            <div id="property-single-carousel" class="owl-carousel owl-arrow gallery-property">
              <div class="carousel-item-b">
                <img src="{{asset('fe/img/slide-2.jpg')}}" alt="">
              </div>
              <div class="carousel-item-b">
                <img src="{{asset('fe/img/slide-3.jpg')}}" alt="">
              </div>
              <div class="carousel-item-b">
                <img src="{{asset('fe/img/slide-1.jpg')}}" alt="">
              </div>
            </div>
          ...
          <div class="col-md-10 offset-md-1">
            ...
            <div class="tab-content" id="pills-tabContent">
              ...
              <div class="tab-pane fade" id="pills-plans" role="tabpanel" aria-labelledby="pills-plans-tab">
                <img src="{{asset('fe/img/plan2.jpg')}}" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-6 col-lg-4">
                <img src="{{asset('fe/img/agent-4.jpg')}}" alt="" class="img-fluid">
              </div>
              <div class="col-md-6 col-lg-4">
