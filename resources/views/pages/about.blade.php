        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="about-img-box">
              <img src="{{asset('fe/img/slide-about-1.jpg')}}" alt="" class="img-fluid">
            </div>
            <div class="sinse-box">
          ...
          <div class="col-md-12 section-t8">
            <div class="row">
              <div class="col-md-6 col-lg-5">
                <img src="{{asset('fe/img/about-2.jpg')}}" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-md-4">
            <div class="card-box-d">
              <div class="card-img-d">
                <img src="{{asset('fe/img/agent-7.jpg')}}" alt="" class="img-d img-fluid">
              </div>
